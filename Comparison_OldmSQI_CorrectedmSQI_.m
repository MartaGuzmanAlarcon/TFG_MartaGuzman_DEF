...
resultados = {
    'mSQI Original', max_original, min_original, resultado_original, NaN, NaN;
    'mSQI Corregido (Arm)', max_corregido_arm, min_corregido_arm, resultado_corregido_arm, diferencia_arm, NaN;
    'mSQI Corregido (Sternum)', max_corregido_sternum, min_corregido_sternum, resultado_corregido_sternum, NaN, diferencia_sternum;
};
