...
% Inicializar arrays para almacenar todos los valores de mSQI
valores_msqi_original = [];
valores_msqi_corregido_arm = [];
valores_msqi_corregido_sternum = [];

for i = 1:num_archivos
    datos_original = mSQI_files_top(i).geometricMean_vector;
    datos_corregido_arm = corrected_files_brazo{i};
    datos_corregido_sternum = corrected_files_esternon{i};
    ...
    % Almacenar todos los valores en vectores columna
    valores_msqi_original = [valores_msqi_original(:); datos_original(:)];
    valores_msqi_corregido_arm = [valores_msqi_corregido_arm(:); datos_corregido_arm(:)];
    valores_msqi_corregido_sternum = [valores_msqi_corregido_sternum(:); datos_corregido_sternum(:)];
end

% Eliminar ceros antes de cálculos estadísticos
...
valores_msqi_original = valores_msqi_original(valores_msqi_original ~= 0);
valores_msqi_corregido_arm = valores_msqi_corregido_arm(valores_msqi_corregido_arm ~= 0);
valores_msqi_corregido_sternum = valores_msqi_corregido_sternum(valores_msqi_corregido_sternum ~= 0);
...
p10_original = prctile(valores_msqi_original, 10);
p90_original = prctile(valores_msqi_original, 90);
p10_corregido_arm = prctile(valores_msqi_corregido_arm, 10);
p90_corregido_arm = prctile(valores_msqi_corregido_arm, 90);
p10_corregido_sternum = prctile(valores_msqi_corregido_sternum, 10);
p90_corregido_sternum = prctile(valores_msqi_corregido_sternum, 90);
